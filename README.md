...
```bash
uv add "ucloud-sandboxes-sdk @ https://github.com/rlrs/ucloud-sandboxes-sdk/releases/download/v0.4.18/ucloud_sandboxes_sdk-0.4.18-py3-none-any.whl"
uv add "ucloud-sandboxes-sdk[async] @ https://github.com/rlrs/ucloud-sandboxes-sdk/releases/download/v0.4.18/ucloud_sandboxes_sdk-0.4.18-py3-none-any.whl"
uv add "ucloud-sandboxes-sdk[inspect] @ https://github.com/rlrs/ucloud-sandboxes-sdk/releases/download/v0.4.18/ucloud_sandboxes_sdk-0.4.18-py3-none-any.whl"
```
